...
In this multivariable linear regression model, we found that all variables except the negative effect are significantly associated with happiness score (life_ladder), while the prediction ability remain moderate. More complex model may be required here for more accurate prediction.
