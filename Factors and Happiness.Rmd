...
```{r}
log_lm_df = lm(life_ladder ~ log_gdp_per_capita, data = happy_df_fac)
...
```{r}
social_lm_df = lm(life_ladder ~ social_support , data = happy_df_fac)
...
```{r}
healthy_lm_df = lm(life_ladder ~ healthy_life_expectancy_at_birth , data = happy_df_fac)
...
```{r}
freedom_lm_df = lm(life_ladder ~ freedom_to_make_life_choices , data = happy_df_fac)
...
```{r}
generosity_lm_df = lm(life_ladder ~ generosity , data = happy_df_fac)
...
```{r}
perceptions_lm_df = lm(life_ladder ~ perceptions_of_corruption , data = happy_df_fac)
...
```{r}
positive_lm_df = lm(life_ladder ~ positive_affect , data = happy_df_fac)
...
```{r}
negative_lm_df = lm(life_ladder ~ negative_affect , data = happy_df_fac)
