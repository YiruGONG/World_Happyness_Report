...
In order use plotly map to show the world happiness score in each country, it is necessary to change the country full name in English to an abbreviated ISO3 form. Therefore, we download the package [countrycode](https://vincentarelbundock.github.io/countrycode/) to help us do the transformation. The resulting data file of `happy_iso3` contains a single dataframe with 1931 rows of data on 12 variables. The detailed information about each variables is lised in following section.
